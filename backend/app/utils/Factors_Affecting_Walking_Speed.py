...
from .weather_helpers import WeatherSpeedModel, map_kma_to_weather
...
class WalkingSpeedIntegrator:
    ...
    def calculate_slope_factor_from_tobler(self, slope_percent: float) -> float:
        """
...
def calculate_route_time(
    ...
    segment_results = integrator.calculate_route_segments(
        segments=segments, user_speed_mps=user_speed_mps, weather_data=weather_data
    )
